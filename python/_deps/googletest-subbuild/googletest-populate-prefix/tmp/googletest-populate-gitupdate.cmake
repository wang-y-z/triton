...
execute_process(
  COMMAND "/bin/git" --git-dir=.git show-ref "release-1.12.1"
  WORKING_DIRECTORY "/home/scratch.isaacw_gpu/Code/triton/python/_deps/googletest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/scratch.isaacw_gpu/Code/triton/python/_deps/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/scratch.isaacw_gpu/Code/triton/python/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "/bin/git" --git-dir=.git submodule update --recursive --init 
    WORKING_DIRECTORY "/home/scratch.isaacw_gpu/Code/triton/python/_deps/googletest-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
